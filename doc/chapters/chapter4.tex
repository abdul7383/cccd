...
and the name of the file which need to be retrieved. Listing bla shows an example for downloading a file named \textit{test.pdf} from the bucket \textit{books} and app \textit{bookstore}.
