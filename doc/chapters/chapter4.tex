...
The Content Adaptation component is a worker process and it listens for new tasks from the Worker Queue. This component is responsible for transcoding or scaling videos. Furthermore it splits the transcoded/scaled videos into segments compatible to the Apple HLS. %Then the video chunks will be uploaded to the Content Distribution component. After that the metadata of the original video. 
